...
```json
{
  "servers": [
	...
	"show_on_shutdown": true							//Show the server when the DCS server is shutdown
    }
  ],
  "assets_path_external": "D:\\your\\folder\\DCSBattlegroundV2\\files\\",		//Uploaded pictures folder
  "dcsmaps_path_external": "D:\\Tools\\06MHR\\DCSBattleground\\DCSMaps\\",		//(Optional) DCS Map folder, you can download the last release here : [DCSMaps](http://06mhr.diciess.fr/temp/DCSMaps.zip)
