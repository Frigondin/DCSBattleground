...
```json
{
  ...
  "dcsmaps_path_external": "D:\\Tools\\06MHR\\DCSBattleground\\DCSMaps\\",		//(Optional) DCS Map folder, you can download the last release here : http://06mhr.diciess.fr/temp/DCSMaps.zip
